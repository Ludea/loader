...
const WMOChunkHandlers = {
	...
	0x4D564552: function(this: WMOFileLoader, data: any): void {
	...
	0x4D4F4844: function(this: WMOFileLoader, data: any): void {
	...
	0x4D4F5458: function(this: WMOFileLoader, data: any, chunkSize: number): void {
		this.textureNames = data.readStringBlock(chunkSize);
	},

	// MFOG (Fog) [WMO Root]
	0x4D464F47: function(this: WMOFileLoader, data: any, chunkSize: number): void {
	...
	0x4D4F4D54: function(this: WMOFileLoader, data: any, chunkSize: number): void {
	...
	0x4D4F5056: function(this: WMOFileLoader, data: any, chunkSize: number): void {
	...
	0x4D4F5054: function(this: WMOFileLoader, data: any): void {
	...
	0x4D4F5052: function(this: WMOFileLoader, data: any, chunkSize: number): void {
	...
	0x4D4F474E: function(this: WMOFileLoader, data: any, chunkSize: number): void {
		this.groupNames = data.readStringBlock(chunkSize);
	},

	// MOGI (Group Info) [WMO Root]
	0x4D4F4749: function(this: WMOFileLoader, data: any, chunkSize: number): void {
	...
	0x4D4F4453: function(this: WMOFileLoader, data: any, chunkSize: number): void {
		const count = chunkSize / 32;
	...
	0x4D4F4449: function(this: WMOFileLoader, data: any, chunkSize: number): void {
		this.fileDataIDs = data.readUInt32Array(chunkSize / 4);
	},

	// MODN (Doodad Names) [WMO Root]
	0x4D4F444E: function(this: WMOFileLoader, data: any, chunkSize: number): void {
	...
	0x4D4F4444: function(this: WMOFileLoader, data: any, chunkSize: number): void {
	...
	0x47464944: function(this: WMOFileLoader, data: any, chunkSize: number): void {
		this.groupIDs = data.readUInt32Array(chunkSize / 4);
	},

	// MLIQ (Liquid Data) [WMO Group]
	0x4D4C4951: function(this: WMOFileLoader, data: any): void {
	...
	0x4D4F4356: function(this: WMOFileLoader, data: any, chunkSize: number): void {
	...
	0x4D44414C: function(this: WMOFileLoader, data: any): void {
		this.ambientColor = data.readUInt32();
	},

	// MOGP (Group Header) [WMO Group]
	0x4D4F4750: function(this: WMOGroupLoader, data: any, chunkSize: number): void {
	...
	0x4D4F5649: function(this: WMOGroupLoader, data: any, chunkSize: number): void {
		this.indices = data.readUInt16Array(chunkSize / 2);
	},

	// MOVT (vertices) [WMO Group]
	0x4D4F5654: function(this: WMOGroupLoader, data: any, chunkSize: number): void {
	...
	// MOTV (UVs) [WMO Group]
	0x4D4F5456: function(this: WMOGroupLoader, data: any, chunkSize: number): void {
		if (!this.uvs)
			this.uvs = [];
	...
	0x4D4F4E52: function(this: WMOGroupLoader, data: any, chunkSize: number): void {
		const count = chunkSize / 4;
	...
	0x4D4F4241: function(this: WMOGroupLoader, data: any, chunkSize: number): void {
	...
	0x4D4F5059: function(this: WMOGroupLoader, data: any, chunkSize: number): void {
...
export class WMOGroupLoader extends WMOFileLoader {
	nameOfs: number;
	descOfs: number;
